package com.tr.nebula.asset.file;

import com.google.common.cache.Cache;
import com.google.common.cache.CacheBuilder;
import com.google.common.net.HttpHeaders;
import com.tr.nebula.asset.AssetProperties;
import com.tr.nebula.asset.AssetServlet;
import com.tr.nebula.asset.util.EncodingUtil;
import com.tr.nebula.common.util.Paths;
...
public class FileAssetServlet extends AssetServlet {
    ...
    protected void doGet(HttpServletRequest req,
        ...
        try {
            ...
            //Get from com.tr.nebula.cache.config if not available load it.
            ...
            if (asset == null){
                if(!assetPath.contains(".")){
                    ...
                    LOGGER.info("Configure Path as " + path);
    ...
    public String getUriPath() {
        String uriPath  = this.uriPath;
        if(!this.uriPath.endsWith("/")) uriPath += "/";
        if(!this.uriPath.endsWith("*")) uriPath += "*";
        return uriPath;
    }
}
